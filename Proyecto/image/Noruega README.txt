...
If you should want to export this again for any reason:
  http://terrain.party/api/export?name=Noruega&box=7.716529,61.000387,7.568294,60.928522
...
-----------
  ...
  * Noruega Height Map (ASTER 30m).png
...
[!] If you look at one height map, look at this one. [!]
  ...
  * Noruega Height Map (SRTM30 Plus).png
...
These heightmaps were adjusted such that 428m (actual) is equal to 40m in
